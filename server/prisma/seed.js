...
async function seedUsers(specializationMap) {
    const [adminPassword, doctorPassword, receptionistPassword, patientPassword] = await Promise.all([
        (0, password_1.hashPassword)('Admin!234'),
        (0, password_1.hashPassword)('Doctor!234'),
        (0, password_1.hashPassword)('Reception!234'),
        (0, password_1.hashPassword)('Patient!234')
    ]);
